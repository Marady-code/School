...
@Repository
public interface ExamResultRepository extends JpaRepository<ExamResult, Long> {    List<ExamResult> findByStudent(Student student);
    List<ExamResult> findByTeacher(Teacher teacher);
    List<ExamResult> findByStudentAndSubject(Student student, Subject subject);
} 