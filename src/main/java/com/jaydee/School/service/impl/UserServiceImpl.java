...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse login(AuthenticationRequest loginRequest) {
        ...
        return userMapper.mapToUserResponse(userRepository.findByEmail(loginRequest.getEmail())
                .orElseThrow(() -> new ResourceNotFound(String.format("User not found with email: %s", loginRequest.getEmail()))));
    }
